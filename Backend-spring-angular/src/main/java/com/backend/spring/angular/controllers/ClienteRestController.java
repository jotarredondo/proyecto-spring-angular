package com.backend.spring.angular.controllers;
...
import com.backend.spring.angular.models.service.IClienteService;
...
public class ClienteRestController {
	...
	public ResponseEntity<?> update (@Valid @RequestBody Cliente cliente,BindingResult result, @PathVariable Long id ) {
		...
		if (clienteActual == null) {
			response.put("mensaje", "Error : el cliente con ID: ".concat(id.toString().concat(" no se pudo encontr ar")));
			return new ResponseEntity<Map<String, Object>>(response, HttpStatus.NOT_FOUND);
		} 
